...
def get_PressureImage(data, file_name):
    ...
    fig2.update_layout(width=300, height=400,
            ...
            if _file == '1':
                for yi in range(height):
                    for xi in range(width):
                        print(data[(yi*10)+xi], end='\t')
                        _data[yi][xi] = data[(yi*10)+xi]
                    print("")
                print("")

                input_str = input("Enter weight(kg): ")

                # if input_str != "":
                #     # ! (Collecting the data)
                #     file_name = "./calibrating/data_collecting-"+ input_str +".csv"
                ...
                #         # print('>>>>> ', now_posture)
                #         # if now_posture != 0:
                #         csv_writer.writerow([datetime, data_1d])
